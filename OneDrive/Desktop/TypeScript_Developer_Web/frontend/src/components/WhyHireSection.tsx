...
const WhyHireSection: React.FC = () => {
  const firstSectionFeatures: FeatureItem[] = [
    {
      title: "Hire Silicon Valley Caliber At Half The Cost",
      description: "Hire The Top 1% Of 15 Million+ Developers From 150+ Countries Who Have Applied To Turing."
    },
    {
  ...
  const secondSectionFeatures: FeatureItem[] = [
    {
      title: "5+ hours of tests and interview",
      description: "Hire the top 1% of 15 million+ developers from 150+ countries who have applied to Turing"
    },
    {
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center mb-16">
          <div className="space-y-6">
            ...
            <div className="space-y-8">
              {secondSectionFeatures.map((feature, index) => (
                <div key={index} className="flex items-start gap-4">
                  <div className="flex-shrink-0 w-6 h-6 rounded-full bg-[#00b289] flex items-center justify-center mt-1">
                    <img src={Checkmark} alt="Checkmark" className="w-3 h-3" />
                  </div>
